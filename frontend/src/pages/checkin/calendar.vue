<template>
  <view class="calendar-wrapper">
    ...
    <view class="days-grid">
      ...
      <view class="stats">
        <view class="stat"><Icon name="ontime" size="sm" color="green" /><text>准时 {{ calendarData?.onTimeCount || 0 }}天</text></view>
        <view class="stat"><Icon name="time" size="sm" color="orange" /><text>迟到 {{ calendarData?.lateCount || 0 }}天</text></view>
        <view class="stat"><Icon name="breakcard" size="sm" color="blue" /><text>补签 {{ calendarData?.breakCount || 0 }}天</text></view>
      </view>
  </view>
  </view>
</template>
...
.calendar-header {
  ...
  .month-title { font-size: 36rpx; font-weight: 500; color: #333; }
}
